// SwiftUI Decision Tree Questionnaire for Learning Path with Result Screen
            ...
            VStack(alignment: .leading, spacing: 20) {
                if showResult {
                    ...
                    if step == 2 {
                        ...
                        ForEach(["Private Equity", "Private Credit", "Real Estate", "Infrastructure", "Venture Capital", "Broad Overview"], id: ".") { type in
